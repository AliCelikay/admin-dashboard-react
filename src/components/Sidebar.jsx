...
// allow us to swtich between different pages
import { Link, NavLink} from 'react-router-dom';
import { SiShopware } from 'react-icons/si';
import { MdOutlineCance, MdOutlineCancel} from 'react-icons/md';
...
const Sidebar = () => {
  ...
  const normalLink= "flex items-center gap-5 pl-4 pt-3 pb-2.5 rounded-lg  text-md text-gray-700 dark:textgray-200 dark:hover:text-black hover:bg-light-gray m-2";
      ...
      <>
        <div className='flex justify-between items-center'>
          ...
          <TooltipComponent content="Menu" position="BottomCenter">
            {/* bring previous state of active menu w/ prevActiveMenu */}
